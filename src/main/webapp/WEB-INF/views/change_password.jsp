					...
					<form method="post" action="update_password">
						<div>
							...
							<div class="col-md-4 column">
								<div style="height: 30px"></div>
								<div>
									<label>输入原密码</label><span id="old-msg" style="color:red;"></span>
									<input type="password" class="form-control"
										id="oldpassword" style="width: 200px" /> <br>
									<label>输入新密码</label><span id="password-msg" style="color:red;"></span>
							...
							<div class="col-md-4 column">
								...
								<div>
									...
									<br>
									<label>再次输入新密码</label><span id="repassword-msg" style="color:red;"></span>
